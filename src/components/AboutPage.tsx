    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-blue-50">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 py-16">
        ...
        <section className="mb-16">
          <h2 className="text-emerald-600 text-lg font-semibold mb-6">
            우리의 미션
          </h2>
            ...
            <CardContent className="p-8">
              <p className="text-xl text-gray-700 leading-relaxed mb-6">
                ...
                <strong className="text-emerald-700">
                  개인의 건강 관리가 사회적 기여로 연결되는
                </strong>{" "}
                혁신적인 스마트 헬스케어 기부 챌린지 플랫폼입니다.
              </p>
              <p className="text-gray-600 leading-relaxed">
                당뇨병, 고혈압 등 만성질환으로 고통받는 많은 분들이 꾸준한 건강
                관리의 어려움을 겪고 있습니다.
              </p>
              <p className="text-gray-600 leading-relaxed">
                동시에 경제적 어려움으로 인해 적절한 치료와 관리를 받지 못하는
                환우들도 많습니다.
              </p>
              <p className="text-gray-600 leading-relaxed">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <Card className="bg-white shadow-sm">
              <CardContent className="p-6">
                ...
                <p className="text-gray-600">
                  아템제약의 후원으로 여러분의 건강 관리가 실제 기부금으로
                  전환됩니다. 추가 비용 부담 없이 선행을 실천할 수 있습니다.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white shadow-sm">
              <CardContent className="p-6">
                ...
                <p className="text-gray-600">
                  건강 리포트로 본인의 건강 상태를 시각화하고, 누적 기부금으로
                  사회적 영향력을 확인하며 동기부여를 받으세요.
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Card className="bg-gradient-to-br from-emerald-50 to-white shadow-sm">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600">
                  단순한 데이터 기록을 넘어, 사회적 의미를 부여함으로써 건강
                  관리의 지속성을 높입니다.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-purple-50 to-white shadow-sm">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600">
                  축적된 건강 데이터를 시각화하여 개인 맞춤형 건강 관리 인사이트를
                  제공합니다.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-amber-50 to-white shadow-sm">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600">
                  모든 기부금 적립 내역과 사용 현황을 투명하게 공개하여 신뢰를
                  구축합니다.
                </p>
              </CardContent>
            </Card>
          ...
          <Card className="bg-gradient-to-r from-emerald-600 to-emerald-700 text-white shadow-lg">
            <CardContent className="p-12 text-center">
              ...
              <p className="mb-6 opacity-80">
                헬시콩은 기술과 공감을 결합하여 건강 형평성을 실현하고,
                <br />
                개인의 작은 실천이 사회 전체의 건강을 증진시키는 생태계를
                구축합니다.
              </p>
            </CardContent>
          </Card>
        ...
        <section>
          ...
          <Card className="bg-white shadow-sm">
            <CardContent className="p-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                우리는 만성질환 관리의 어려움을 직접 경험한 사람들, 그리고 그
                가족들의 이야기에서 출발했습니다.
              </p>
              <p className="text-gray-700 leading-relaxed">
                기술이 단순히 편리함을 넘어 사회적 가치를 창출할 수 있다는
                믿음으로, 오늘도 더 나은 헬스케어 생태계를 만들기 위해 노력하고
                있습니다.
              </p>
            </CardContent>
          </Card>
        ...
        <div className="mt-16 text-center">
          ...
          <div className="flex gap-4 justify-center">
            ...
            >
              <a href="mailto:contact@healthykong.com">문의하기</a>
            </Button>
          </div>
        </div>
      </div>
