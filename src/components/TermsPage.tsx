            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  본 약관은 헬시콩(HealthyKong, 이하 "회사")이 제공하는 스마트 헬스케어
                  기부 챌린지 플랫폼 서비스(이하 "서비스")의 이용과 관련하여 회사와
                  이용자의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다. 서비스를
                  이용하시기 전에 본 약관을 자세히 읽어주시기 바랍니다.
                </p>
              </div>
            </div>
          </CardContent>
          ...
          <Card>
            <CardContent className="p-6 space-y-4">
              <div>
                ...
                <p className="text-gray-600">
                  본 약관은 회사가 제공하는 서비스의 이용 조건 및 절차, 회사와 이용자
              ...
              <div>
                ...
                <ul className="space-y-2 text-gray-600">
                  <li>
                    <strong>① "서비스"</strong>란 만성질환 관리를 위한 건강 데이터 기록,
                    기부금 적립, 건강 리포트 제공 등 회사가 제공하는 모든 서비스를
                    말합니다.
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>③ "회원"</strong>이란 회사와 서비스 이용계약을 체결하고
                    아이디를 부여받은 이용자를 말합니다.
                  </li>
                  <li>
                    <strong>④ "기부금"</strong>이란 회원의 건강 관리 활동에 따라
                    파트너사의 후원으로 적립되는 가상의 금액을 말합니다.
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600">
                  ...
                  변경할 수 있으며, 약관을 변경할 경우 적용일자 및 변경사유를 명시하여
                  최소 7일 전에 공지합니다.
                </p>
              </div>
            </CardContent>
          ...
          <Card>
            <CardContent className="p-6 space-y-4">
              <div>
                ...
                <p className="text-gray-600 mb-2">
                  ① 이용계약은 이용자가 본 약관에 동의하고 회원가입 신청을 한 후 회사가
                  이를 승낙함으로써 성립합니다.
                </p>
                <p className="text-gray-600">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  ...
                  수정할 수 있습니다. 회원은 회원가입 시 기재한 사항이 변경되었을 경우
                  즉시 수정하여야 하며, 수정하지 않아 발생한 문제의 책임은 회원에게
                  있습니다.
                </p>
              </div>
          ...
          <Card>
            <CardContent className="p-6 space-y-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  ② 제1항에 의한 서비스 중단의 경우 회사는 사전에 통지합니다. 다만,
                  회사가 통제할 수 없는 사유로 인한 서비스의 중단으로 인하여 사전 통지가
                ...
                <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-3">
                  <div className="flex items-start gap-2">
                    ...
                    <p className="text-gray-700 text-sm">
                      <strong>중요:</strong> 기부금은 파트너사(아템제약)의 후원으로 적립되는
                      가상의 금액이며, 회원이 직접 금전을 지불하거나 수령하지 않습니다.
                    </p>
                  </div>
                </div>
                <ul className="space-y-2 text-gray-600">
                  <li>
                    <strong>① 적립 조건:</strong> 회원이 당일 처음으로 건강 데이터를
                    기록할 때 100원이 자동 적립됩니다.
                  </li>
                  <li>
                    <strong>② 적립 한도:</strong> 1일 1회, 1개월 최대 3,000원까지 적립
                    가능합니다.
                  </li>
                  <li>
                    <strong>③ 기부 실행:</strong> 누적 기부금이 10,000원 이상 적립되면
                    자동으로 지정된 환자 지원 프로그램에 기부됩니다.
                  </li>
                  <li>
                    <strong>④ 투명성:</strong> 모든 기부금 적립 및 사용 내역은 마이페이지에서
                    확인할 수 있습니다.
                  </li>
                </ul>
              </div>
          ...
          <Card>
            <CardContent className="p-6 space-y-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  회원이 입력하는 건강 데이터는 본인의 실제 측정 결과를 정확히 기록해야
                  합니다. 허위 데이터 입력으로 인한 건강상의 문제 또는 서비스 이용 제한에
                  대한 책임은 회원에게 있습니다.
                </p>
              </div>
            </CardContent>
                ...
                <ul className="space-y-2 text-gray-600">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      위한 보안 시스템을 구축하며 개인정보 처리방침을 공시하고 준수합니다.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-5 h-5 text-emerald-600 flex-shrink-0 mt-0.5" />
                    <span>
                      회사는 서비스 이용과 관련하여 발생하는 이용자의 불만 또는 피해구제
                      요청을 적절하게 처리하기 위한 절차를 마련합니다.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-lg p-6">
                ...
                <div className="space-y-3 text-gray-700">
                  <p>
                    ...
                    제공되는 정보는 참고용일 뿐 의학적 진단, 치료, 처방의 대체 수단이 될
                    수 없습니다. 의료적 결정은 반드시 전문의와 상담하시기 바랍니다.
                  </p>
                  <p>
                    <strong>② 천재지변 등:</strong> 회사는 천재지변 또는 이에 준하는
                    불가항력으로 인하여 서비스를 제공할 수 없는 경우에는 서비스 제공에
                    관한 책임이 면제됩니다.
                  </p>
                  <p>
                    <strong>③ 회원의 귀책사유:</strong> 회사는 회원의 귀책사유로 인한
                    서비스 이용의 장애에 대하여 책임을 지지 않습니다.
                  </p>
                  <p>
                    <strong>④ 제3자 제공 정보:</strong> 회사는 회원이 서비스를 이용하여
                    기대하는 수익을 얻지 못하거나 상실한 것에 대하여 책임을 지지 않으며,
          ...
          <Card>
            <CardContent className="p-6 space-y-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  ② 회사와 이용자 간에 발생한 분쟁은 전자거래기본법 제28조 및 동 시행령
              ...
              <div>
                ...
                <p className="text-gray-600 mb-2">
                  ① 회사와 이용자 간에 발생한 전자거래 분쟁에 관한 소송은 민사소송법상의
                  관할법원에 제기합니다.
                </p>
                <p className="text-gray-600">
                  ② 회사와 이용자 간에 제기된 전자거래 소송에는 대한민국 법을
                  적용합니다.
                </p>
              </div>
            </CardContent>
